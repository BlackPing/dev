...
(select(),topicselect(),getMessage(a.msg))})});$(".channel-delete").off().on("click",function(a){confirm("\uc815\ub9d0 \uc0ad\uc81c\ud558\uc2dc\uaca0\uc2b5\ub2c8\uae4c?")&&(a=$(this).parent().children(".channel-no").text(),a=a.substr(4,a.length),getData("POST","/topicdel",{no:a},function(a){a=JSON.parse(a);0==a.status?getMessage(a.msg)||alert("\ub124\ud2b8\uc6cc\ud06c \uc624\ub958\uc785\ub2c8\ub2e4."):(select(),topicselect(),getMessage(a.msg))}))})}})}
...
a.account[a.topic[c].TOPIC_NO]+"\uba85</span>",b+="</div>";$("#app-topic").append(b);$("#topic-refresh").on("click",function(a){topicselect()});$(".channel-btn").off().on("click",function(a){a=$(this).parent().children(".channel-no").text();a=a.substr(4,a.length);getData("POST","topicup",{no:a},function(a){a=JSON.parse(a);0==a.status?getMessage(a.msg)||alert("\ub124\ud2b8\uc6cc\ud06c \uc624\ub958\uc785\ub2c8\ub2e4."):(getMessage(a.msg),void 0!=Socket&&(select(),topicselect()))})});$(".app-topic-list span").off().on("click",
